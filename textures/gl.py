...
class Renderer(object):
    ...
    def glModelMatrix(self, translate = (0,0,0), scale =(1,1,1), rotate=(0,0,0)):
        ...
        Rxy = libreria.multi4x4matrix(Rx,Ry)
        MatrixRot = libreria.multi4x4matrix(Rxy, Rz)
        Mtr = libreria.multi4x4matrix(translation, MatrixRot)
        result = libreria.multi4x4matrix(Mtr, scaleMat)
